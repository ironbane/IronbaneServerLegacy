...
/* fock */dictionary.fock = /\b((?!facebook)f+(\W|\d|_)*(0|a|o)+(\W|\d|_)*(c|k)+(\W|\d|_)*(c|k)+(\W|\d|_)*)\b|\b(f+(\W|\d|_)*(0|a|o)+(\W|\d|_)*(c|k)+(\W|\d|_)*(c|k)+(\W|\d|_)*\w*)/i;
/* foreskin */dictionary.foreskin = /\b(f+(\W|\d|_)*(0|o)+(\W|\d|_)*r+(\W|\d|_)*(3|e)+(\W|\d|_)*(5|s|z)+(\W|\d|_)*(c|k)+(\W|\d|_)*(1|i)+(\W|\d|_)*n+(\W|\d|_)*)\b/i;
/* fuck */dictionary.fuck = /\b((?!fax)(?!facebook)((\w)|())+(\W|\d|_)*(f|v)+(\W|\d|_)*(v|u|a|o)+(\W|\d|_)*(c|k|x)+(\W|\d|_)*(k|c|))/i;
...
/* puta */dictionary.puta = /\b(((\w)|())+(\W|\d|_)*(p)+(\W|\d|_)*(u)+(\W|\d|_)*(t)+(\W|\d|_)*(a|@|0))/i;
