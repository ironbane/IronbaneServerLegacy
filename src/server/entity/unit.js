...
var Unit = Class.extend({
    ...
    side: new THREE.Vector3(), // a vector perpendicular to the heading vector
    mass: 10.0,
    maxSpeed: 5.0, // the maximum speed at which this entity may travel.
    init: function(data) {
        _.extend(this, data);
        ...
        this.rotx = this.rotx || 0;
        this.roty = this.roty || 0;
        this.rotz = this.rotz || 0;
