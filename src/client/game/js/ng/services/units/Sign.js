...
IronbaneApp.factory("Sign", ["Mesh", function(Mesh){
  var Sign = function(position, rotation, id, param, metadata) {
  ...
  Sign.prototype.BuildMesh = function(geometry, jsonMaterials) {
  ...
  Sign.prototype.tick = function(dTime) {


    Mesh.prototype.tick.apply(this, arguments);
