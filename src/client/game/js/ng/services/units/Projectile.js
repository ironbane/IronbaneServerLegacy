...
IronbaneApp.factory("Projectile",["Unit",function(Unit){
    var Projectile = function(position, targetPosition, owner, weaponID) {
    ...
    Projectile.prototype.Add = function() {
        this._super();
    ...
    Projectile.prototype.tick = function(dTime) {
        this.lifeTime -= dTime;
    ...
    Projectile.prototype.Impact = function(hasHitTerrain) {
    ...
    Projectile.prototype.CalculateFiringAngle = function(target, throwHigh) {
