...
IronbaneApp.factory("ParticleEmitter", ["TextureHandler",function(TextureHandler){
var ParticleEmitter = function (type, data) {
    ...
    ParticleEmitter.prototype.tick =function (dTime) {
