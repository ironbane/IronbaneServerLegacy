...
IronbaneApp.service("ParticleTypeEnum", ["ZoneConstants", "TextureHandler",function(ZoneConstants, TextureHandler){
    this.TEST = {
        texture: function() {
    ...
    this.DAMAGE1 = {
        ...
        particleStartScale: new THREE.Vector2(1, 1),
        particleOpacity: function(p) {
            return ParticleFunctions.OpacityLifeTime(p, 0.0, 0.9);
        }
    };
    this.DAMAGE2 = {
    ...
    this.PLASMABALL = {
        ...
        particleOpacity: function(p) {
            return ParticleFunctions.OpacityLifeTime(p, 0.2, 0.8);
        }
    };
    this.SNOWFLAKE = {
        texture: 'projectiles/snowflake',
        delay: 0,
        // The amount of particles to spawn
        // -1 = infinite (default)
        count: 1,
    ...
    this.CLOUD = {
        ...
        particleStartPosition: function() {
            ...
            pos.y = ZoneConstants.getZoneConfig('cloudLevel') + getRandomFloat(-5, 5);
            return pos;
        },
        particleStartVelocity: function() {
        ...
        particleDelay: function() {
            return (2.0 - parseFloat(ZoneConstants.getZoneConfig('cloudDensity')).clamp(0.1, 2));
        },
        ...
        particleOpacity: function(p) {
            return (ParticleFunctions.OpacityLifeTime(p, 0.02, 0.98)) * 0.5;
        }
    };
    this.TELEPORTENTRANCE = {
        texture: function() {
    ...
    this.TELEPORTENTRANCECIRCLES = {
        ...
        particleStartScale: new THREE.Vector2(2.5, 2.5),
        particleOpacity: function(p) {
            return ParticleFunctions.OpacityLifeTime(p, 0.5, 0.5);
        },
        particleScaleVelocity: new THREE.Vector2(-0.6, -0.6)
    };
    this.TELEPORTEXITCIRCLES = {
        texture: function(p) {
            var index = Math.abs(p.count) % 2;
            return (['particles/circle1', 'particles/circle2'])[index];
        },
