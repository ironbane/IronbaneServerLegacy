...
* @constructor
*/
IronbaneApp.service('UnitList', function(){
    	var unitlist = [];
        ...
        **/
		this.findUnit = function(searchOption){
            if(angular.isNumber(searchOption)){
                var id = searchOption;
            ...
            if(angular.isFunction(searchOption)){
        ...
        **/
        this.iterate = function(func){
            angular.forEach(unitlist, function(unit){
                func(unit);
            });
        };
        /**
        ...
        **/
        this.destroy = function(){            
            this.iterate(function(unit){ unit.Destroy()});
        };
         /**
        * @method tick
        * @param {Number} dTime
