...
IronbaneApp.factory("Player",["Fighter",function(Fighter){
    var Player =  function(position, rotation, id, name) {

        // Add a small offset
        position.y += 1;

        Fighter.apply(this, [position, rotation, id, name, 0,
    ...
    Player.prototype.getTotalCoins = function() {
    ...
    Player.prototype.checkForItemsBeforeMakingImage = function() {
    ...
    Player.prototype.destroyAimMesh= function() {
        if (this.aimMesh) {
    ...
    Player.prototype.destroyAimHelperMesh = function() {
    ...
    Player.prototype.onChangeZone = function(newZone) {
    ...
    Player.prototype.positionTheCamera = function(target, dTime) {
    ...
    Player.prototype.hideLoot = function() {
        var player = this;
    ...
    Player.prototype.showLoot = function(found) {
    ...
    Player.prototype.tick =function(dTime) {
        var player = this;
    ...
    Player.prototype.attemptAttack = function(position) {
        var player = this;
    ...
    Player.prototype.useItem = function(barIndex) {
        var player = this;
    ...
    Player.prototype.updateAppearance = function() {
        var player = this,
            special;
        ...
        angular.forEach(player.getItems(), function(item) {
            if (item.equipped) {
    ...
    Player.prototype.updateMouseProjectedPosition = function() {
    ...
    Player.showTutorial = function(id) {
        $(".ib-tutorial").addClass("tut" + id);
    };
    Player.hideTutorial= function(id) {
