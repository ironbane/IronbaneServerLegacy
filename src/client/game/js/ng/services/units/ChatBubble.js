...
IronbaneApp.factory("ChatBubble", ["PhysicsObject","UnitList", function(PhysicsObject, UnitList){
    var ChatBubble = function(unit, text) {
    ...
    ChatBubble.prototype.MakeTextMesh = function(text) {
    ...
    ChatBubble.prototype.tick = function(dTime) {
        // Count the amount of bubbles that are on top of the player
        var me = this;
        var foundOurselves = false;
        var count = UnitList.findUnits(function(unit){
