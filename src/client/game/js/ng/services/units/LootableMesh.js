...
IronbaneApp.factory("LootableMesh", ["Mesh",function(Mesh){
  var LootableMesh = function(position, rotation, id, param, metadata) {
...
//    }
  ...
  LootableMesh.prototype.BuildMesh = function(geometry, jsonMaterials) {
  ...
  LootableMesh.prototype.tick =function(dTime) {
    this._super(dTime);
  };
  return LootableMesh;
}]);
