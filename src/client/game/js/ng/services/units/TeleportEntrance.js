...
IronbaneApp.factory("TeleportEntrance", ["Unit", function(Unit){
    var TeleportEntrance = function(position, id, metadata) {
    ...
    TeleportEntrance.prototype.Add= function() {
        this._super();
    ...
    TeleportEntrance.prototype.tick = function(dTime) {
