...
IronbaneApp.factory("TeleportExit",["Unit", function(Unit){
    var TeleportExit = function(position, id, metadata) {
    ...
    TeleportExit.prototype.Add = function() {
        this._super();
    ...
    TeleportExit.prototype.tick = function(dTime) {
