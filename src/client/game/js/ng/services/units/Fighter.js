...
IronbaneApp.factory("Fighter",["Unit",function(Unit){
    var Fighter = function(position, rotation, id, name, param, size, health, armor, healthMax, armorMax) {
        this.items = [];
        ...
        Unit.apply(this,[position, rotation, id, name, param, size]);
    ...
    Fighter.prototype.addItem = function(item) {
        this.items.push(item);
    },
    Fighter.prototype.Add = function() {
        Unit.prototype.Add.apply(this);
    };
    Fighter.prototype.Destroy = function() {
        if (this.weaponOrigin) {
            ironbane.scene.remove(this.weaponOrigin);
        }
        Unit.prototype.Destroy.apply(this);
    };
    Fighter.prototype.updateClothes = function(appearanceOverride) {
        var me = this,
    ...
    Fighter.prototype.updateWeapon = function(weapon) {
        if (this.weaponOrigin) {
    ...
    Fighter.prototype.tick = function(dTime) {
        ...
        if (this.health > 0) {
            Unit.prototype.tick.apply(this,[dTime]);
    ...
    Fighter.prototype.swingWeapon = function(pos, weapon) {
    ...
    Fighter.prototype.doMeleeHitAnimation = function(position, power) {
    ...
    Fighter.prototype.GetMeleeHit = function(attacker, power) {
        if (attacker) {
    ...
    Fighter.prototype.playSound = function(sound) {

        soundHandler.Play(sound, this.position);

    };
    Fighter.prototype.die = function(noParticle) {
    ...
    Fighter.prototype.Respawn = function() {
    ...
    Fighter.prototype.setHealth = function(newHealth, noParticles) {
    ...
    Fighter.prototype.setArmor = function(newArmor, noParticles) {
