...
IronbaneApp.factory("Mesh", ["Unit", "$injector", "ParticleTypeEnum","ParticleHandler","MeshHandler", function(Unit, $injector, ParticleTypeEnum, ParticleHandler, MeshHandler){
  
  var Mesh = function(position, rotation, id, param, metadata) {
    ...
    Unit.apply(this,[position, rotation, id, 'Mesh', param]);
  ...
  Mesh.prototype.Decorate = function() {
  ...
  Mesh.prototype.UpdateLighting = function() {
    var TerrainHandler = $injector.get("TerrainHandler");
  ...
  Mesh.prototype.BuildMesh = function(geometry, jsonMaterials) {
    ...
    this.boundingBox.size = _.clone(this.boundingBox.max).sub(this.boundingBox.min);
    ...
    _.each(this.mesh.geometry.vertices, function(vertex) {
      this.startVertices.push(_.clone(vertex));
    }, this);
  ...
  Mesh.prototype.UpdateRotationByVertices = function() {
  ...
  Mesh.prototype.tick = function(dTime) {
    ...
    Unit.prototype.tick.apply(this,arguments);
