...
IronbaneApp.factory("HeartPiece", ["Billboard", function(Billboard){
    var HeartPiece = function(position, id) {
    ...
    HeartPiece.prototype.Add = function() {
        this._super();
    ...
    HeartPiece.prototype.tick = function(dTime) {
