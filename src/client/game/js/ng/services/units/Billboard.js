...
IronbaneApp.factory("Billboard", ["Unit",function(Unit){
    var Billboard = function(position, rotY, id, param, customPath, customName) {
    ...
    Billboard.prototype.Add =function() {
    ...
    Billboard.prototype.TryToBuildMesh = function() {
    ...
    Billboard.prototype.BuildMesh = function() {
    ...
    Billboard.prototype.tick= function(dTime) {
        this._super(dTime);
