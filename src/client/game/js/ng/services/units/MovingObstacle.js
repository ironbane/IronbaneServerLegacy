...
IronbaneApp.factory("MovingObstacle",["DynamicMesh", function(DynamicMesh){
    var MovingObstacle = function(position, rotation, id, param, metadata) {
        this._super(position, rotation, id, param, metadata);
    };
    MovingObstacle.prototype.tick = function(dTime) {
