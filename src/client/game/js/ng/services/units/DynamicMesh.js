...
IronbaneApp.factory("DynamicMesh",["Mesh",function(Mesh){
    var DynamicMesh = function(position, rotation, id, param, metadata) {
        ...
        if ( angular.isDefined(this.metadata.movementType) ) this.movementType = parseInt(this.metadata.movementType, 10);
        if ( angular.isDefined(this.metadata.speedMultiplier) ) this.speedMultiplier = parseFloat(this.metadata.speedMultiplier);
        if ( angular.isDefined(this.metadata.distanceMultiplier) ) this.distanceMultiplier = parseFloat(this.metadata.distanceMultiplier);
...
// //        this.RotateVertices();
//     },
    DynamicMesh.prototype.tick = function(dTime) {
