...
.filter('mouthwash', [function() {
	...
	/* clit, cunt */dictionary.cunt = /\b(((\w)|())+(\W|\d|_)*(c)+(\W|\d|_)*(l|1|!|u)+(\W|\d|_)*(i|1|!|n)+(\W|\d|_)*(t|d))/ig;
	...
	/* cum */dictionary.cum = /\b(((\w)|())+(\W|\d|_)*(c|k)+(\W|\d|_)*(u)+(\W|\d|_)*(m))/ig;
	/* dick, dike, hardon, dildo */dictionary.dick = /\b(d+(\W|\d|_)*(1|i)+(\W|\d|_)*(c|k)+(\W|\d|_)*(c|k)+(\W|\d|_)*)|\b(d+(\W|\d|_)*(1|i)+(\W|\d|_)*k+(\W|\d|_)*(3|e)+(\W|\d|_)*)|\b(d+(\W|\d|_)*(1|i)+(\W|\d|_)*(1|l)+(\W|\d|_)*(1|l)*(\W|\d|_)*d+(\W|\d|_)*(0|o)+(\W|\d|_)*)|\b(d+(\W|\d|_)*y+(\W|\d|_)*(c|k)+(\W|\d|_)*(3|e)+(\W|\d|_)*)|\b(h+(\W|\d|_)*a+(\W|\d|_)*r+(\W|\d|_)*d+(\W|\d|_)*(0|o)+(\W|\d|_)*n+(\W|\d|_)*)\b|\b((c|k)+(\W|\d|_)*u+(\W|\d|_)*m+(\W|\d|_)*m+(\W|\d|_)*i+(\W|\d|_)*n+(\W|\d|_)*g+(\W|\d|_)*)\b/ig;
	...
	/* doosh, dooch, douche */dictionary.doosh = /\b(((\w)|())+(\W|\d|_)*(d)+(\W|\d|_)*(o|0)+(\W|\d|_)*(o|0|u)+(\W|\d|_)*(s|c|5)+(\W|\d|_)*(h))/ig;
	...
	/* fock */dictionary.fock = /\b(f+(\W|\d|_)*(0|a|o)+(\W|\d|_)*(c|k)+(\W|\d|_)*(c|k)+(\W|\d|_)*)\b|\b(f+(\W|\d|_)*(0|a|o)+(\W|\d|_)*(c|k)+(\W|\d|_)*(c|k)+(\W|\d|_)*\w*)/ig;
	/* foreskin */dictionary.foreskin = /\b(f+(\W|\d|_)*(0|o)+(\W|\d|_)*r+(\W|\d|_)*(3|e)+(\W|\d|_)*(5|s|z)+(\W|\d|_)*(c|k)+(\W|\d|_)*(1|i)+(\W|\d|_)*n+(\W|\d|_)*)\b/ig;
	/* fuck */dictionary.fuck = /\b((?!fax)((\w)|())+(\W|\d|_)*(f|v)+(\W|\d|_)*(v|u|a|o)+(\W|\d|_)*(c|k|x)+(\W|\d|_)*(k|c|))/ig;
	...
	/* puto, puta */dictionary.puta = /\b(((\w)|())+(\W|\d|_)*(p)+(\W|\d|_)*(u)+(\W|\d|_)*(t)+(\W|\d|_)*(a|@|o|0))/ig;
