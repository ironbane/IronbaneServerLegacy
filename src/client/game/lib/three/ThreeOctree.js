...
( function ( THREE ) {
  ...
  THREE.OctreeNode = function ( parameters ) {
    ...
    if ( this.tree.scene ) {
      ...
      this.visual = new THREE.Mesh( new THREE.CubeGeometry( this.radiusOverlap * 2, this.radiusOverlap * 2, this.radiusOverlap * 2 ), new THREE.MeshBasicMaterial( {
        color: 0xFF0000,
        wireframe: true,
  ...
  THREE.OctreeNode.prototype = {
    ...
    remove_object: function ( object ) {
      ...
      removeData = this.remove_object_end( object, {
